...
STAGES: list[Stage] = [
    ...
    Stage(2, "Получение разрешения от здания и допуск рабочих",
          "Building permit & worker access"),
    ...
    Stage(8, "Кондиционерные работы (в закрываемой части потолка)",
          "HVAC works (in enclosed ceiling)"),
    Stage(9, "Подготовка потолочных коробов", "Ceiling bulkhead preparation"),
    Stage(10, "Электротехнические работы", "Electrical works"),
    Stage(11, "Водопроводные работы в туалетной и кухонной зонах",
          "Plumbing in toilet & kitchen areas"),
    Stage(12, "Водозащитные работы и получение согласования от здания",
          "Waterproofing & building approval"),
    Stage(13, "Бетонирование пола", "Floor concreting"),
    Stage(14, "Укладка плитки", "Tiling"),
    Stage(15, "Затирка и завершение отделочных работ в туалетах",
          "Grouting & toilet finishing"),
    ...
    Stage(20, "Металлические воздуховоды в зонах с открытым потолком",
    ...
    Stage(26, "Установка света и переключателей, розеток",
          "Lighting, switches & sockets installation"),
    Stage(27, "Установка столярной мебели", "Joinery/millwork installation"),
    Stage(28, "Доставка и установка передвижной мебели",
          "Loose furniture delivery & installation"),
    Stage(29, "Получение сертификата соответствия и устранение недоделок",
